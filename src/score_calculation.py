...
_FIRST_UNDERTRICK_VALUE: Dict[Tuple[bool, int], int] = {
    (False, 0): 50,
    (False, 1): 100,
    (False, 2): 200,
    (True, 0): 100,
...
_SECOND_THIRD_UNDERTRICK_VALUE: Dict[Tuple[bool, int], int] = {
    (False, 0): 50,
    (False, 1): 200,
    (False, 2): 400,
    (True, 0): 100,
...
_SUBSEQUENT_UNDERTRICK_VALUE: Dict[Tuple[bool, int], int] = {
    (False, 0): 50,
    (False, 1): 300,
    (False, 2): 600,
    (True, 0): 100,
...
def calculate_score(level: int, suit: Optional[BiddingSuit], doubled: int, tricks: int, vulnerable: bool) -> int:
    ...
    if scoring_tricks >= level:
        ...
        subsequent_tricks_score = _TRICK_VALUE[suit] * \
            double_multiplier * (level - 1)
        bonus = _calculate_bonus(
            level, suit, doubled, vulnerable, first_trick_score +
            subsequent_tricks_score, scoring_tricks - level
        )
